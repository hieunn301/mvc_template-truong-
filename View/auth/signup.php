...
<div class="wrap">
    <section>
        ...
        <div class="content">
            <form class="content-form" action="<?php echo $host[0].'?controller=authen&action=register-post'?>" method="post">
                <p>
                        Họ và tên:</br>
                <input class="input-text" type="text" placeholder="Họ và tên" name="fullname"
                       value="<?php echo !empty($_POST['fullname']) ? $_POST['fullname'] : false;
                       ?>"
                >
                </br>
                <?php
                ...
                <p>
                    ...
                    <input class="input-text" type="text" placeholder="Số điện thoại" name="phone_number"
                           value="<?php echo !empty($_POST['phone_number']) ? $_POST['phone_number'] : false;
                           ?>"
                    >
                    </br>
                    <?php
